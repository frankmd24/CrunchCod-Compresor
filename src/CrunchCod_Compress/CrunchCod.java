...
import CrunchCod_Compress.HuffmanCompress.HuffmanBytes;
import CrunchCod_Compress.LZ77_GraphCompress.Compresor_FF;
import CrunchCod_Compress.LZ77_GraphCompress.Grafo;
import Utils.Convert;
import Utils.Validation;


public class CrunchCod {
    public static File compress(File file, String address, String nameFinal, int tamBloque, int ventanaDesplazamiento,
            int longMinima) throws IOException {
        ...
        // Creo el fichero nuevo donde va a estar la nueva informacion, se crea aqui
        // arriba para si hay problema con la direccion
        ...
        // Serializo el grafo diviendo en info de los nodo (0) y informacion reducida
        // (1)
        ...
        // Escribo en el fichero toda la informacion, la estructura del fichero es la
        // siguiente
        // int||nombre del fichero|| bytes del arbol de hufman || int || info
        // codificada|| int || bytes del grafo || int
    ...
    public static File descompress(File file, String address) throws IOException, ClassNotFoundException {
        // int||nombre del fichero|| int || bytes del grafo || int || bytes del arbol de
        // hufman || int || info codificada
        // Lanzar exception si el fichero no existe
        Validation.existFile(file);
        ...
        // Creo el fichero donde se va a guardar la informacion, se crea aqui en caso de
        // que haya problema con la direccion
